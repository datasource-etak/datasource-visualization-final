...
namespace BlazorDatasource.Shared
{
    ...
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            var pi = instanceType.GetProperty(propertyName) ?? throw new Exception(string.Format("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType));
            if (!pi.CanWrite)
